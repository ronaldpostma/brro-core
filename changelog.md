...
- [ ] When comments are turned off, only comment REST endpoints are removed instead of all core REST routes; added `brro_filter_comment_rest_endpoints` in `brro-core-admin.php`. Fixes Site Health REST test and WooCommerce/core REST usage.
